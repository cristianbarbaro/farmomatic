...
class PlantationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plantation" do
    assert_difference('Plantation.count') do
      post farm_plot_plantations_url(farm_id: 1, plot_id: 1), params: { plantation: { amount: @plantation_one.amount, comment: @plantation_one.comment, plot_id: @plantation_one.plot_id, species_id: @plantation_one.species_id, user_id: 1 } }
    end
  ...
  test "should update plantation" do
    patch farm_plot_plantation_url(1,1,@plantation_one), params: { plantation: { amount: @plantation_one.amount, comment: @plantation_one.comment, plot_id: @plantation_one.plot_id, species_id: @plantation_one.species_id, user_id: 1 } }
