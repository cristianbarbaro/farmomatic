...
class TypeProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_problem" do
    assert_difference('TypeProblem.count') do
      post type_problems_url, params: { type_problem: { description: @type_problem.description, name: @type_problem.name, scientific_name: @type_problem.scientific_name, url: @type_problem.url } }
    end
  ...
  test "should update type_problem" do
    patch type_problem_url(@type_problem), params: { type_problem: { description: @type_problem.description, name: @type_problem.name, scientific_name: @type_problem.scientific_name, url: @type_problem.url } }
