...
class PlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plot" do
    assert_difference('Plot.count') do
      post plots_url, params: { plot: { description: @plot.description, greenhouse: @plot.greenhouse, identifier: @plot.identifier, surface: @plot.surface } }
    end
  ...
  test "should update plot" do
    patch plot_url(@plot), params: { plot: { description: @plot.description, greenhouse: @plot.greenhouse, identifier: @plot.identifier, surface: @plot.surface } }
