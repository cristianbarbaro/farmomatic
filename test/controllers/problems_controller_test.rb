...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { comment: @problem.comment, plot_id: @problem.plot_id, type_problem_id: @problem.type_problem_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { comment: @problem.comment, plot_id: @problem.plot_id, type_problem_id: @problem.type_problem_id } }
